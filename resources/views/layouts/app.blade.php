                ...
                <div class="modal-body">
                    ...
                    <form method="post" action="" name="loginForm" id="loginForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <p class="gotpw"><a href="" data-bs-toggle="modal"
                                        data-bs-target="#forgot">Forgot
                                        Password?</a></p>
                                {{-- <p class="link"><a href="" data-bs-toggle="modal" data-bs-target="#reset"><i>Reset
											Password</i></a></p> --}}
                            </div>
                            <div class="col-md-4 text-right">
                                <button disabled id="loginButton" class="btn btn-theme float-end"
                                    data-bs-toggle="modal" data-bs-target="#loginotp"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="otp-input">
                                        ...
                                        <input type="text" name="enterLoginOtp" id="enterLoginOtp"
                                            class="form-control form-otp" autocomplte="off" minlength="6"
                                            maxlength="6" placeholder="" />

                                    </div>
                                    <label id="otpError" class="validation-error">Please Enter valid 6 Digit
                                        otp</label>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3 label-modal ">
                                <div class="form-group">
                                    <label>Enter your OTP</label>
                                    <div class="otp-input">
                                        <input type="text" minlength="6" maxlength="6" name="forgotOtp"
                                            id="forgotOtp" class="form-control form-otp" autocomplte='off'
                                            placeholder="" />
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12 text-center">
                                <button disabled id="forgot_submit" type="submit"
            ...
            @if (Auth::check())
                ...
                @php
                    if (Auth::user()->user_balance_allocated != null) {
                        $allotted_balance = Auth::user()->user_balance_allocated->allotted_balance;
                        $available_balance = Auth::user()->user_balance_allocated->used_balance;
                        $user_leftbalances = $allotted_balance - $available_balance;
			 ...
			 float-end">
                    <div class="row">
                        ...
                        <div class="col-md-4 text-end  top-details">
                            ...
                            <p>{{ number_format($user_leftbalance, 2) }}</p>
                        </div>
                        <div class="col-md-4 text-end  top-details">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6 footer-links">
                        ...
                        <ul>
                            ...
                            <li><i class="bx bx-chevron-right"></i> <a href="{{ route('services') }}">Services</a>
                            </li>
                            <li><i class="bx bx-chevron-right"></i> <a href="{{ route('contact') }}">Contact Us</a>
                            </li>
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        <h4></h4>
                        <ul>
                            <li><i class="bx bx-chevron-right"></i> <a href="{{ route('privacy') }}">Privacy
                                    Policy</a>
                            </li>
                            <li><i class="bx bx-chevron-right"></i> <a href="{{ route('terms-conditions') }}">Terms
                                    of
                                    Service</a></li>
