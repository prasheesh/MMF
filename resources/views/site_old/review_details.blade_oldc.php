                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-shadow">
                            ...
                            //echo "<pre>"; print_r($tripInfos->totalPriceList);
                                ...
                                $basefare = $basefare + $tripInfos->totalPriceList[0]->fd->ADULT->fC->BF;  ///getting base fare for total trips
                            ...
                            <div class="mt-3 mb-3 cancelation-tab">
                                ...
                                <div class="tab-content ps-3" id="pills-tabContent">
                                    <div class="tab-pane fade <?php if (isset($fair_rules->fr->CANCELLATION)) {
                                        ...
                                        <h6>{{ $result_array->tripInfos[0]->sI[0]->da->city }} -
                                            {{ $result_array->tripInfos[0]->sI[0]->aa->city }}</h6>
                ...
                <div class="col-md-3 p-3 mt30 ">
                    ...
                    <div class="card">
                        <div class=" card-body card-shadow">
                            ...
                            $Taxes = $result_array->tripInfos[0]->totalPriceList[0]->fd->ADULT->fC->TAF;
