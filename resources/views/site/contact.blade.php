            ...
            <form action="" method="post" name="contactForm" id="contactForm"role="form" class="php-email-form">
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="name" class="form-control allowtext" id="name" placeholder="Your Name" required="">
                </div>
    ...
    <script>
     ...
     //email validation
            $("#contact_email").change(function(){
                ...
                if (testEmail.test($("#contact_email").val()))
                {
                    $("#email_error").text('');
