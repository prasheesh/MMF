                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        ...
                                                        <a href="{{ route('reviewDetails') }}?pKey0={{ $values->id }}">
                                                            <button id="one_way_book_now" class="btn btn-book-now">Book Now</button> </a>
                                                    </td>
                                ...
                                <div class="airport-name-inner">
                                    ...
                                    <label>
                                        ...
                                        @if ($_GET['tripType'] != 'multi')
                                            <input class="form-control bg-none date-picker-hide" required autocomplete="off" id="flightBookingDepart" style="padding:4px 0px;"
                                                name="flightBookingDepart" placeholder="Please select..."
                                                value="{{ $_GET['flightBookingDepart'] }}" />
                                        @else
                                            <input class="form-control date-picker-hide" required autocomplete="off" id="flightBookingDepart"
                                                name="flightBookingDepart" placeholder="Please select..."
                                                value="" />
                                        @endif
                                    </label>
                    ...
                    <div class="card">
                        <div class=" card-body card-shadow">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="text-end mt-2"><a href="#">View More Fares</a></div>
                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:25%">
                                                            <div>
                                                                ...
                                                                ?>
                                                                <small data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Plane change  {{ $value->sI[$i]->aa->city }} | {{ $connect_hours }} Layover">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6 text-end">
                                                                            ...
                                                                            <span><a href="#"class="btn btn-outline-primary btn-sm"
                                                                                    ...
                                                                                    onclick="getFareRules({{ $tis->sI[0]->id }})">View More Fares</a></span>
                                                                        </div>
                                                                    </div>
                                                                    <hr>
