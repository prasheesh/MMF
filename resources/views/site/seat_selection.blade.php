...
@section('content')
    ...
    <input type="hidden" name="no_of_passenger" id="no_of_passenger"
        value="{{ count($request->session()->get('first_name')) }}">
        ...
        <div class="container container-make">
            <div class="row">
                <div class="col-md-9 p-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <input type="hidden" name="bookingId" id="bookingId" class="form-control" placeholder=""
                                value="<?php echo $_GET['bookingId']; ?>">
                                                ...
                                                @if (isset($v1->ssrInfo->MEAL))
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link" id="pills-profile-tab"
                                                            data-bs-toggle="pill"
                                                            data-bs-target="#pills-profile{{ $v1->id }}"
                                ...
                                <div class="tab-content ps-3" id="pills-tabContent">
                                    @if ($result_array->status->success == true && $result_array->status->httpStatus == 200)
                                        @if (isset($review->tripInfos))
                                            @if (isset($result_array->tripSeatMap))
                                                ...
                                                @foreach ($result_array->tripSeatMap->tripSeat as $key => $value)
                                                    @if (isset($value->sData))
                                                        ...
                                                        <div class="tab-pane fade show " id="pills-home{{ $key }}"
                                                            role="tabpanel" aria-labelledby="pills-home-tab">
                                                            <div class="hyderabad-booking">


                                                                <h6>{{ $flight_array[$seg_id]->da->city }} -
                                                                    {{ $flight_array[$seg_id]->aa->city }}</h6>
                                                                {{-- <p>0 of 1 selected</p> --}}
                                                            ...
                                                            <div class="row align-items-end">
                                                                ...
                                                                <div class="col-md-8  meals-seats">
                                                                    <div class="seats-bg">
                                                                        ...
                                                                        <img src="{{ 'assets/img/booking-front-crop.png' }}"
                                                                            class="img-fluid">
                                                                        <div class="flight-seats">
                                                                            ...
                                                                            @for ($i = 1; $i <= $row; $i++)
                                                                                <ul class="select-seat-ul">
                                                                                    <input type="hidden" name="seat_chrge"
                                                                                        id="seat_chrge" value="0">
                                                                        ...
                                                                        <img src="{{ 'assets/img/booking-black.png' }}"
                                                                            class="img-fluid">
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            @endif
                                        @else
                                            <h4>{{ $review->errors[0]->errCode . ' - ' . $review->errors[0]->message }}
                                            </h4>

                                        @endif
                                    @else
                                        <h4>{{ $result_array->errors[0]->errCode . ' - ' . $result_array->errors[0]->message }}
                                        </h4>
                                    @endif
                                    ...
                                    @if (isset($review->tripInfos))
                                        ...
                                        @foreach ($review->tripInfos as $k => $v)
                                            @foreach ($v->sI as $k1 => $v1)
                                                @if (isset($v1->ssrInfo->MEAL))
                                                    <div class="tab-pane fade" id="pills-profile{{ $v1->id }}"
                                    ...
                                    @foreach ($v->sI as $k1 => $v1) --}}
                                                                   ...
                                                                   <span>Non-Veg</span>
                                                                        ...
                                                                        @foreach ($v1->ssrInfo->MEAL as $k2 => $v2)
                                                                            <div
                                                                                class="row align-items-center meals-parent">
                                                                                <div class="col-md-2 ">
                                                                                    <img src="assets/img/veg-curry1.png"
                                                                                        class="img-fluid">
                                                                                </div>
                                                                                <div class="col-md-8 meals-headtxt">
                                                                                    <h6>{{ $v2->desc }}</h6>
                                                                                    @if (isset($v2->amount))
                                                                                        <p><b><i class="fa-solid fa-indian-rupee-sign"></i>
                                                                                                {{ $v2->amount }}</b></p>
                                                                                    @endif
                                                                                </div>
                                                                                <div class="col-md-2 ">
                                                                                    ...
                                                                                    <input type="hidden"
                                                                                        name="meal_amount"
                                                                                        id="meal_amount" value="0">
                                                                                    {{-- {{ dd($segment_key, $k) }} --}}
                                                                                    <button
                                                                                        data-segment_key="{{ $segment_key[$segment_array[$seg_m_id]] }}"
                                                                                        data-meal_code="{{ $v2->code }}"
                                                                                        class="btn btn-add"
                                                                                        id="meal_code{{ $v2->code }}{{ $v1->id }}"
                                                                                        onclick="addMeals('{{ $v2->code }}','{{ $meal_amt }}','{{ $v1->id }}')">ADD</button>
                                                                                </div>
                                                                            </div>
                                                                        @endforeach
                                                                    </div>
                            ...
                            <div class="mt-5 float-end d-flex">
                                <div class="" data-bs-toggle="modal" data-bs-target="#confirmBookingModal">
                                    <button class="btn btn-blue-continue confirmBooking1"><a> Skip & Proceed</a></button>
                                </div>
                                <div class="ms-1" data-bs-toggle="modal" data-bs-target="#confirmBookingModal">
                                    <button class="btn btn-blue-continue confirmBooking1"><a> Proceed to Pay</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class=" card-body card-shadow">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span class="">
                                                                Adult(s) <br><small
                                                                    style="font-size: 12px;">({{ $adults }} X ₹
                                                                    {{ number_format($adult_bf, 2) }})</small>
                                                            </span>
                                                        </td>
                                                        <td>:</td>
                                                        <td width="45%">
                                                    ...
                                                    @if ($childs > 0)
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="">
                                                                    Child(s) <br><small
                                                                        style="font-size: 12px;">({{ $childs }} X ₹
                                                                        {{ number_format($child_bf, 2) }})</small>
                                                                </span>
                                                            </td>
                                                            <td>:</td>
                                                            <td width="45%">
                                                    ...
                                                    @if ($infants > 0)
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="">
                                                                    Infant(s) <br><small
                                                                        style="font-size: 12px;">({{ $infants }} X ₹
                                                                        {{ number_format($infant_bf, 2) }})</small>
                                                                </span>
                                                            </td>
                                                            <td>:</td>
                                                            <td width="45%">
                                            ...
                                            <h2 class="accordion-header" id="headingOne">
                                                <button type="button" class="accordion-button collapsed"
                                                    ...
                                                    <span class="ms-2">Other Charges </span> <span class="ms-auto"> <i
                                                            ...
                                                            id="othercharges"> </span></span>
                                                </button>
                                            </h2>
                                            <div id="collapseOne3" class="accordion-collapse collapse seat_amt d-none"
                                                data-bs-parent="#myAccordion">
                                                <small class="ms-3">
                                                    <span>Seats</span>
                                                    <span class="float-end"> <i class="fa-solid fa-indian-rupee-sign"></i>
                                                        <span id="seat_amt"></span></span>
                                                </small>
                                            </div>
                                            <div id="collapseOne3" class="accordion-collapse collapse meal_amt d-none"
                                                data-bs-parent="#myAccordion">
                                                <small class="ms-3">
                                                    <span>Meals</span>
                                                    <span class="float-end"> <i class="fa-solid fa-indian-rupee-sign"></i>
                                                        <span id="meal_amt"></span></span>
                                                </small>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row ">
                                        ...
                                        @php $ttl_price = $review->totalPriceInfo->totalFareDetail->fC->TF @endphp
                                        <div class="col-md-5  text-end">
                                            <i class="fa-solid fa-indian-rupee-sign"></i> <span
                                                data-ttl_price="{{ $ttl_price }}"
                                                id="ttl_price">{{ $ttl_price }}</span>
        ...
        function seatSelection(code, seat_amt, flight_id) {
            ...
            if (seat_selection < no_of_passenger) {
                ...
                if (selected_seat == 0) {
                    ...
                    $("#seat" + code + flight_id).addClass('seat-selected seat-selected' + flight_id + ' ' + code +
                        flight_id + ' selected' + all_seat_selected);
                    $("#seat" + code + flight_id).attr("data-seat_select_id", all_seat_selected);
                    var segment_key = $("#seat" + code + flight_id).attr("data-segment_key");
                    $("#seat" + code + flight_id).append('<input type="hidden" name="seat_selected[]" data-flight_id="' +
                        flight_id + '" value="' + code + '" data-segment_key = "' + segment_key + '" />');
                    // alert(count)
                } else {
                    setTimeout(function() {
                        $("#loader_div").hide();
                    ...
                    $('#seat_amt').html(ttl_seat_charge);
                    $('#ttl_price').html(price);
                    $("#seat" + code + flight_id).removeClass('seat-selected seat-selected' + flight_id + ' ' + code +
                        flight_id + ' selected' + selected_seat_id);
        ...
        function addMeals(code, meal_amt, flight_id) {
            ...
            if (meal_selected_cnt < no_of_passenger) {
                if (selected_meals == 0) {
                    ...
                    $('#meal_code' + code + flight_id).addClass('meal-selected meal-selected' + flight_id + ' ' + code +
                        flight_id + ' selected_meals' + meal_selected_cnt);

                    var segment_key = $("#meal_code" + code + flight_id).attr("data-segment_key");

                    $("#meal_code" + code + flight_id).append('<input type="hidden" name="meal_selected[]"  value="' +
                        code + '" data-segment_key = "' + segment_key + '" data-flight_id="' + flight_id + '" />');
                    ...
                    $('#meal_code' + code + flight_id).removeClass('meal-selected meal-selected' + flight_id + ' ' + code +
                        flight_id + ' selected_meals' + meal_selected_cnt);
            ...
            $(".confirmBooking").click(function() {
                ...
                $('input[name="seat_selected[]"]').each(function() {
                    seats.push({
                        name: 'seat_code',
                        value: $(this).val(),
                        flight_id: $(this).attr('data-flight_id'),
                        segment_key: $(this).attr('data-segment_key')
                    });
                });
