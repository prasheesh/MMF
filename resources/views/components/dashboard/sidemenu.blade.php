<div class="leftpart">
    <ul class="main-menu">
        ...
        <li><a href="{{route('bookings.index')}}"><i class="fas fa-calendar"></i> Bookings</a></li>
        <li><a href="{{route('finance.index')}}"><i class="fas fa-money-bill"></i> Finance</a></li>
        ...
        <li><a href="{{route('balance.with.users.index')}}"><i class="fas fa-user-check"></i> Balance with Users</a></li>
